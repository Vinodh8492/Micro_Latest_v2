...
class ProductionOrder(db.Model):
    ...
    recipe = db.relationship('Recipe', backref='production_orders')  # Relationship to Recipe table
...
class BatchMaterialDispensing(db.Model):
    ...
    batch = db.relationship('Batch', backref='batch_material_dispensings', passive_deletes=True)
